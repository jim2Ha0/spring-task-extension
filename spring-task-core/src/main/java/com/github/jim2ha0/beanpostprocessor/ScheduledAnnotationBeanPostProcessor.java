...
public class ScheduledAnnotationBeanPostProcessor
    ...
    private final NamedScheduledTaskRegistrar registrar;
    ...
    public ScheduledAnnotationBeanPostProcessor() {
        this.registrar = new NamedScheduledTaskRegistrar();
    }

    /**
     * Create a {@code ScheduledAnnotationBeanPostProcessor} delegating to the
     * specified {@link NamedScheduledTaskRegistrar}.
     * @param registrar the ScheduledTaskRegistrar to register @Scheduled tasks on
     * @since 5.1
     */
    public ScheduledAnnotationBeanPostProcessor(NamedScheduledTaskRegistrar registrar) {
